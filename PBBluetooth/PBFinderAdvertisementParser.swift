...
class PBFinderAdvertisementParser: PBAdvertisementParser {
    ...
    override func update(withAdvertisement data: [String : Any], manufacturerData: Data, device: PBDevice) {
        ...
        guard manufacturerData.count >= 8, let finder = device as? PBFinder1 else {
            return
        }
        ...
        if let name = finder.name {
            descString += "\(name): "
        }else{
            descString += "My Finder: " + (finder.macAddress ?? "unknownMac") + " "
        }
        ...
        case 0b0010:
            ...
            if finder.buttonState == PBButtonState.none {
                switch buttonPush {
                case 0b01:
                    finder.buttonState = .singlePress
                case 0b10:
                    finder.buttonState = .longPress
                case 0b11:
                    finder.buttonState = .doublePress
                default:
                    break
                }
        ...
        case 0b0:
            ...
            if finder.buzzState != .iddle{
                finder.buzzState = .iddle
            }
        case 0b1:
            descString += "Buzzing: Yes \(String(buzzing, radix: 2)), "
            if finder.buzzState != .buzzing{
                finder.buzzState = .buzzing
            }
        default:
        ...
        case 0b0:
            ...
            if finder.advertisementState != .high{
                finder.advertisementState = .high
            }
        case 0b1:
            descString += "Ad State: Low \(String(adState, radix: 2)), "
            if finder.advertisementState != .low{
                finder.advertisementState = .low
            }
        default:
            descString += "Ad State: Unknown \(String(adState, radix: 2)), "
            if finder.advertisementState != .unknown{
                finder.advertisementState = .unknown
            }
        }
        ...
        case 0b01:
            ...
            if finder.buttonState != .singlePress {
                finder.buttonState = .singlePress
            }
        case 0b10:
        ...
        case 0b11:
            ...
            if finder.buttonState != .doublePress {
                finder.buttonState = .doublePress
            }
        default:

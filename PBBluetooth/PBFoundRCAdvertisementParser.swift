...
class PBFoundRCAdvertisementParser: PBFinderAdvertisementParser {
    ...
    override internal func update(withAdvertisement data: [String : Any], manufacturerData: Data, device: PBDevice) {
        ...
        guard manufacturerData.count >= 8, let foundRC = device as? PBFoundRC else {
            return
        }
        ...
        if let name = foundRC.name {
            descString += "\(name): "
        }else{
            descString += "My BlackCard: " + (foundRC.macAddress ?? "unknownMac")
        }
        ...
        case 0b0010:
            ...
            if foundRC.buttonState == PBButtonState.none {
                switch buttonPush {
                case 0b01:
                    foundRC.buttonState = .singlePress
                case 0b10:
                    foundRC.buttonState = .longPress
                case 0b11:
                    foundRC.buttonState = .doublePress
                default:
                    break
                }
        ...
        case 0b0:
            ...
            if foundRC.buzzState != .iddle{
                foundRC.buzzState = .iddle
            }
        case 0b1:
            descString += "Buzzing: Yes \(String(buzzing, radix: 2)), "
            if foundRC.buzzState != .buzzing{
                foundRC.buzzState = .buzzing
            }
        default:
        ...
        case 0b0:
            ...
            if foundRC.advertisementState != .high{
                foundRC.advertisementState = .high
            }
        case 0b1:
            descString += "Ad State: Low \(String(adState, radix: 2)), "
            if foundRC.advertisementState != .low{
                foundRC.advertisementState = .low
            }
        default:
            descString += "Ad State: Unknown \(String(adState, radix: 2)), "
            if foundRC.advertisementState != .unknown{
                foundRC.advertisementState = .unknown
            }
        }
        ...
        case 0b01:
            ...
            if foundRC.buttonState != .singlePress {
                foundRC.buttonState = .singlePress
            }
        case 0b10:
        ...
        case 0b11:
            ...
            if foundRC.buttonState != .doublePress {
                foundRC.buttonState = .doublePress
            }
        default:
